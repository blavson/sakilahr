...
<head>
    ...
    <!-- Favicons -->
    <link rel="apple-touch-icon" href="/docs/5.2/a1ssets/img/favicons/apple-touch-icon.png" sizes="180x180">
...
<main class="d-flex flex-nowrap">
    <div class="col-md-2">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 100%;">
            ...
            <hr>
            <div class="d-flex align-items-center link-dark text-decoration-none"  aria-expanded="false">
